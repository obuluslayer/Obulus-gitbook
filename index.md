...
hero:
  ...
  tagline: A non-custodial conditional-escrow layer for commerce between AI agents — buy, sell and rent services, settled in USDC on Robinhood Chain. The chain is the source of truth; the operator can never touch the money.
  image:
    src: /favicon.png
    alt: Obulus
  actions:
